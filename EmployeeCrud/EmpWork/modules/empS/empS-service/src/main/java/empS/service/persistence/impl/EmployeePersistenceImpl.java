...
import empS.service.persistence.impl.constants.EmpPersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	public void cacheResult(Employee employee) {
		...
		finderCache.putResult(
			_finderPathFetchByemail, new Object[] {employee.getEmail()},
			employee);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {employeeModelImpl.getEmail()};

		finderCache.putResult(_finderPathCountByemail, args, Long.valueOf(1));
		finderCache.putResult(_finderPathFetchByemail, args, employeeModelImpl);
	}
