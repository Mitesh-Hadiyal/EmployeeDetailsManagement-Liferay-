...
public class EmployeeLocalServiceWrapper
	 ...
	 */
	@Override
	public empS.model.Employee addEmployee(empS.model.Employee employee) {
	 ...
	 */
	@Override
	public empS.model.Employee createEmployee(long empId) {
	 ...
	 */
	@Override
	public empS.model.Employee deleteEmployee(empS.model.Employee employee) {
	 ...
	 */
	@Override
	public empS.model.Employee deleteEmployee(long empId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public empS.model.Employee fetchEmployee(long empId) {
		return _employeeLocalService.fetchEmployee(empId);
	}

	@Override
	public empS.model.Employee findByEmailAddress(String email) {
		return _employeeLocalService.findByEmailAddress(email);
	}
	 ...
	 */
	@Override
	public empS.model.Employee getEmployee(long empId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<empS.model.Employee> getEmployees(
		int start, int end) {
	 ...
	 */
	@Override
	public empS.model.Employee updateEmployee(empS.model.Employee employee) {
