 ...
 * <code>empS.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>empS.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Employee findByEmailAddress(String email) {
		return getService().findByEmailAddress(email);
	}
