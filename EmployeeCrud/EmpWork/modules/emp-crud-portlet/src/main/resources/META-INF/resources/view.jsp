	 	        ...
	 	        { title: 'Email ID', data: 'email' },
	 	       	...
	 	       	{	
	                 ...
	                 "mRender" : function ( data, type, row ) {
	                     return '<i onClick="setData('+data.empId+')" style="color:rgb(49, 80, 242);" class="fa-solid fa-pen-to-square" data-bs-target="#exampleModal" data-bs-toggle="modal" data-bs-whatever="@fat"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i onClick="deleteRow('+data.empId+')" style="color:red" class="fa-solid fa-trash-arrow-up"></i>';
	                 }
	            }
	 	    ],
	 	    data: dataSet
